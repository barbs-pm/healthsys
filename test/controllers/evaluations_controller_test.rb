...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference("Evaluation.count") do
      post evaluations_url, params: { evaluation: { appointment_id: @evaluation.appointment_id, opinion: @evaluation.opinion } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { appointment_id: @evaluation.appointment_id, opinion: @evaluation.opinion } }
